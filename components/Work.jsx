...
const Work = ({isDarkMode}) => {
  return (
    ...
    id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      Welcome to Our web development portfolio! Explore a collection of projects showcasing Ourexpertise in full stack development.</motion.p>
